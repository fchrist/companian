...
@Path("products/{productId}/jars/{jarid}/doc/bindings/{bindingName}")
public class BindingCapabilityPage extends AbstractPageRenderer {

    private static Logger logger = LoggerFactory.getLogger(BindingCapabilityPage.class);
    ...
    public Response getBindingPage(@PathParam("productId") int productId,
                                   @PathParam("jarid") int jarId,
                                   @PathParam("bindingName") String bindingName) {
        if (logger.isDebugEnabled()) {
            logger.debug("getBindingPage() " + bindingName + " for JAR " + jarId);
        }
    ...
    public Response postDescription(@PathParam("productId") int productId,
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("postDescription() for " + bindingName + ", JAR " + jarId + ", content: " + content);
        }
